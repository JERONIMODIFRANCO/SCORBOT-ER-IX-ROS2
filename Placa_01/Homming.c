...
int homming(void){
    static int fin_homming1 = 0, fin_homming2 = 0, fin_homming3 = 0;
    static int fin_homming = 0;
    static int primera_init = 1;

    if(primera_init){
        if (!fin_homming3) {fin_homming3 = homming_junta( Angulo_grados_eje_3,  HOME_SW_3,  &angulo_3, 5, -106);}
        if (!fin_homming2 & fin_homming3 == 1) {fin_homming2 = homming_junta( Angulo_grados_eje_2,  HOME_SW_2,  &angulo_2, 5, 2);}
        if (!fin_homming1 & fin_homming2 == 1) {fin_homming1 = homming_junta( Angulo_grados_eje_1,  HOME_SW_1,  &angulo_1, 8, 20);}
        fin_homming = fin_homming1 * fin_homming2 * fin_homming3;
        if(fin_homming1 & fin_homming2 & fin_homming3){
    //        fin_homming = 1;
            fin_homming1 = 0;
            fin_homming2 = 0;
            fin_homming3 = 0;
