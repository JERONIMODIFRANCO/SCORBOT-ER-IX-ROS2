...
//FIN
    ...
    if((p->theta_raw < 4294967296)&&(p->theta_raw > 4294791959/2)){
       p->angle_robot = -7.716e-4*(p->theta_raw)+3314003.765;
    }
    if((p->theta_raw < 152251*2)&&(p->theta_raw > 0)){
