...
volatile float Angulo_grados_eje_1 = 0, Angulo_grados_eje_2 = 0, Angulo_grados_eje_3 = 0;
...
volatile float Offset_grados_eje_1 = 0, Offset_grados_eje_2 = 0, Offset_grados_eje_3 = 0;
//
...
void Angle_Reset(int eje, volatile float *Actual_Angle, float angulo_reset){
    switch(eje){
    case 1:
        Offset_grados_eje_1 = -Offset_grados_eje_1 -1*(qep_posspeed_1.angle_robot) + angulo_reset;
        *Actual_Angle = angulo_reset;
        break;
    case 2:
        Offset_grados_eje_2 = -Offset_grados_eje_2 -1*(qep_posspeed_2.angle_robot) + angulo_reset;
        *Actual_Angle = angulo_reset;
        break;
    case 3:
        Offset_grados_eje_3 = -Offset_grados_eje_3 -1*(qep_posspeed_3.angle_robot) + angulo_reset;
        *Actual_Angle = angulo_reset;
        break;
    }
}
