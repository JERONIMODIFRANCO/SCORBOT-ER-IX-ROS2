...
void Angle_Reset(int eje, volatile float *Actual_Angle, float angulo_reset){
    switch(eje){
    case 1:
        Offset_grados_eje_1 = -1*(qep_posspeed_1.angle_robot) + angulo_reset;
        *Actual_Angle = angulo_reset;
        break;
    case 2:
        Offset_grados_eje_2 = -1*(qep_posspeed_2.angle_robot) + angulo_reset;
        *Actual_Angle = angulo_reset;
        break;
    case 3:
        Offset_grados_eje_3 = -1*(qep_posspeed_3.angle_robot) + angulo_reset;
        *Actual_Angle = angulo_reset;
        break;
    }
}
