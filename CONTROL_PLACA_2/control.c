...
int16 rk2 = 0.0f;
int16 yk1 = 0, yk2 = 0, e1 = 0, e2 = 0;
float uk1, uk2, uz1, uz2;
volatile Naxis4 = 180, Naxis5 = 100;
...
volatile float corriente_real_con_signo_1 = 0, corriente_real_con_signo_2 = 0;
