...
├── sbot_moveit
    ...
    │      ├── scorbot.ros2_control.xacro: ROS2 control configuration and ROS2 Control plugin for ignition  in xacro format.
...
```bash
ros2 launch sbot_moveit_gazebo moveit_gz.launch.xml
```
