...
int16 rk2 = 0.0f;
int16 rk3 = 0.0f;
int16 yk1 = 0, yk2, yk3, e1=0, e2=0, e3=0;          //YK ACUTAL
volatile float Naxis1 = 214.13, Naxis2 = 243.8, Naxis3 = 213.33;
float uk1, uk2, uk3, uz1, uz2, uz3;                  // SALIDAS DE PID
...
volatile DCL_PID pid4 = PID_4_DEFAULTS; //LOS 3 DE ABAJO NO SE USAN ERAN PARA PID DE CORRIENTE
...
//        }
        ...
        // ROS CONTROL TRANSFORMAMOS A ANGULO DE MOTOR
        rk1 = angulo_1*Naxis1;   // Descomentar para usarlo normal
        rk2 = angulo_2*Naxis2;
        rk3 = angulo_3*Naxis3;
        ...
        e3 = rk3 - yk3;
        //
        // Corrientes reales con signo por los drivers [A] NO LO NECESITAMOSSS PAPA
        //
        ...
        // 
        uk1 = DCL_runPID_C3(&pid1, rk1, yk1, 0.0f)+380; // LOS 380 SI BIEN MI AMIGO NO LO DICE CLARAMENTE
        uk2 = DCL_runPID_C3(&pid2, rk2, yk2, 0.0f)+380; // SON EL 50% DEL CICLO DE TRABAJO DEL PWM
        uk3 = DCL_runPID_C3(&pid3, rk3, yk3, 0.0f)+380; // PARA QUE EL BRACITO NO SE CAIGA JEJE
