...
// Defines
//
#define POSSPEED_1_DEFAULTS {0x0,0x0, 0x0,0x0,0x0,0x0,8589.312,0x0,1,0,0x0,\ //EL 8589 ES EL MECH SCALER 
                          370,0,1000,0,\
                           0,0,0,\
...
#define POSSPEED_3_DEFAULTS {0x0,0x0, 0x0,0x0,0x0,0x0,8589.312,0x0,1,0,0x0,\
                          370,0,1000,0,\
                           0,0,0,\
                           (void (*)(long))POSSPEED_3_Init,\
                          (void (*)(long))POSSPEED_3_Calc }


extern volatile float Naxis1 = 214.13, Naxis2 = 243.8, Naxis3 = 213.33;
//
// Globals
//
typedef struct {//int theta_elec;         // Output: Motor Electrical angle (Q15)
                ...
                Uint32 cal_angle;       // LO CAMBIO MI AMIGO PERO NO AVISO
...
typedef POSSPEED *POSSPEED_3_handle;
//
// Function Prototypes
//
...
void POSSPEED_3_Calc(POSSPEED_3_handle);
//
//
