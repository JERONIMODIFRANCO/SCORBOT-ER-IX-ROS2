   ...
   .. tabs::
      ...
      .. group-tab:: Local
         ...
         .. code-block:: shell
           ...
           ros2 launch ros2_control_example view_robot.launch.py
      ...
      .. group-tab:: Docker
        ...
        .. code-block:: shell
          ...
          docker run -it --rm --name ros2_control_demos --net host ros2_control_demos ros2 launch ros2_control_example view_robot.launch.py gui:=false
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 launch ros2_control_example rrbot.launch.py
      ...
      .. group-tab:: Docker
        ...
        .. code-block:: shell
          ...
          docker run -it --rm --name ros2_control_demos --net host ros2_control_demos ros2 launch ros2_control_example rrbot.launch.py gui:=false
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 launch ros2_control_example test_forward_position_controller.launch.py
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 launch ros2_control_example test_joint_trajectory_controller.launch.py
